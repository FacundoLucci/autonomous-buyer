...
if (!["preview", "silent", "cues", "voice"].includes(mode))
...
const args = [
  ...
  "render",
  "src/index.ts",
  cueMode ? "BuyHardCues" : "BuyHardSilent",
  `out/buy-hard-${mode}.mp4`,
  "--codec=h264",
  "--crf=18",
...
if (mode === "voice") {
  ...
  if (!existsSync(path.resolve(projectRoot, propsPath)))
    throw new Error(
      "Provide voice-props.json with voiceover or voiceClips before rendering the voiced cut.",
    );
