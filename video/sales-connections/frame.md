...
description: >
  ...
  borders, hard offset shadows (no blur), Arimo uppercase at 0.92 line-height,
  Share Tech Mono taxonomy, Arimo body, the four-accent palette. Composition,
...
typography:
  ...
  body-lg:    { fontFamily: "Arimo", px: 28, cqw: 1.46, weight: 400, lineHeight: 1.4 }
  body-md:    { fontFamily: "Arimo", px: 24, cqw: 1.25, weight: 400, lineHeight: 1.3 }
  mono-label: { fontFamily: "Share Tech Mono", px: 24, cqw: 1.25, weight: 400, tracking: "0.06em", upper: true }
  mono-kicker:{ fontFamily: "Share Tech Mono", px: 24, cqw: 1.25, weight: 400, tracking: "0.14em", upper: true }
  table-head: { fontFamily: "Arimo", px: 28, cqw: 1.46, weight: 400, upper: true }
  # — display / hero ramp (frame-native, cqw-first) —
  step-title: { fontFamily: "Arimo", px: 34,  cqw: 1.77, weight: 400, lineHeight: 1.0, upper: true }
  badge-label:{ fontFamily: "Arimo", px: 28,  cqw: 1.46, weight: 400, upper: true }
  marker:     { fontFamily: "Arimo", cqw: 2.4, weight: 400, lineHeight: 1.0, upper: true }
  stamp-num:  { fontFamily: "Arimo", cqw: 2.2, weight: 400, lineHeight: 0.9 }
  stat-num:   { fontFamily: "Arimo", cqw: 6.4, weight: 400, lineHeight: 0.88 }
  step-num:   { fontFamily: "Arimo", cqw: 7.0, weight: 400, lineHeight: 0.85 }
  display-head: { fontFamily: "Arimo", cqw: 4.2, weight: 400, lineHeight: 0.92, tracking: "-0.01em", upper: true }
  display-lg: { fontFamily: "Arimo", cqw: 8.0,  weight: 400, lineHeight: 0.9,  tracking: "-0.01em", upper: true }
  display-xl: { fontFamily: "Arimo", cqw: 11.0, weight: 400, lineHeight: 0.9,  tracking: "-0.01em", upper: true }
  display-hero:{ fontFamily: "Arimo", cqw: 15.5,weight: 400, lineHeight: 0.84, tracking: "-0.02em", upper: true }
...
- **Fonts** — already set to **Arimo** (display) / **Share Tech Mono** (body); ignore any preset font name lingering in prose.
...
The display voice is **Arimo in strict uppercase at 0.92 line-height** — letters overlap
their own cap height; that tightness is the brand. **Share Tech Mono** carries every label, kicker,
counter, and axis as a "technical artifact" register. **Arimo** carries the few body lines.
...
- **Arimo uppercase**, 0.92 line-height, always; sentence-case Arimo does not exist.
...
- **Uppercase + 0.92 line-height on all Arimo**, always. Mono carries 0.06–0.14em tracking. Never letter-space Arimo beyond the encoded −0.01em; never set body centered.
...
**Fixed** Arimo uppercase 0.84 lh, one accent on the wordmark, square corners. **Free** which
...
- Size headlines **fit-to-measure**; render Arimo uppercase at 0.92 lh.

### Don't

- Don't round corners (except the pill chip); don't gradient, blur, or glow.
- Don't set Arimo in sentence case or letter-space it beyond −0.01em.
- Don't use all four accents on one frame, a fifth accent, or pure white.
- Don't center body copy or set labels in anything but Share Tech Mono.
...
- **Type** — Arimo uppercase 0.92 lh, fit-to-measure, ≥1.4cqw on load-bearing lines.
...
- **Arimo requires Google Fonts**; fallback is `sans-serif`. CJK pairing (Noto Serif SC 900 / NSC 400) carries over from the source's CJK section.
...
## UI mock adaptation
The preset font remixer did not replace its display font. Use bundled Arimo for the requested consistent app typography, with bold 700 display weight, Share Tech Mono for labels, and the existing app's light borders and 8px radii for the two UI panels. No frame numbering. All font files are local.

Arimo is bundled under the OFL and closely matches the app Arial layout. Display and body share this family.
