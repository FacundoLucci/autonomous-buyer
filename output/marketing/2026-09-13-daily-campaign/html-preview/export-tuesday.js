async (page) => {
  ...
  for (const id of ['your_existing_supplier','no_because']) {
    ...
    await board.screenshot({path:'/Users/facundo/repos/github/buyer/output/playwright/tuesday-campaign/'+id+'.png',type:'png',scale:'css',animations:'disabled'});
