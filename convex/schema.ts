...
export default defineSchema({
  ...
  companyOrders: defineTable({
    ...
    browserPreparedJobId: v.optional(v.string()),
    browserHelpKind: v.optional(v.union(v.literal("supplier"), v.literal("payment"))),
    browserProgress: v.optional(v.string()),
    browserTermsPending: v.optional(v.boolean()),
    ...
    browserPollFailures: v.optional(v.number()),
