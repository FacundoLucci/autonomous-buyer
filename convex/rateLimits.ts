...
export const limits = new RateLimiter(components.rateLimiter, {
  ...
  mailDomain: { kind: "token bucket", rate: 20, period: HOUR, capacity: 20 },
  mailDocument: { kind: "token bucket", rate: 20, period: HOUR, capacity: 20 },
  mailDraft: { kind: "token bucket", rate: 30, period: HOUR, capacity: 30 },
